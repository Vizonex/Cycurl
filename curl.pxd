...
cdef extern from "curl/curl.h":
    ...
    int CURLINFO_DOUBLE   
    int CURLINFO_SLIST    
    int CURLINFO_PTR # SAME AS SLIST
    int CURLINFO_SOCKET   
    int CURLINFO_OFF_T    
    int CURLINFO_MASK     
    ...
    CURL *curl_easy_init()
    CURLcode curl_easy_setopt(CURL *curl, CURLoptionption, ...)
    ...
    ctypedef size_t (*curl_read_callback)(char *buffer, size_t size,size_t nitems, void *instream)
